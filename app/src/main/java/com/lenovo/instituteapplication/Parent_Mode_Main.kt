...
class Parent_Mode_Main : AppCompatActivity() {
    lateinit var par_home_tab: LinearLayout
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_parent_mode_main)
        ...
        bottom_nav = findViewById<BottomNavigationView>(R.id.stu_bottom_navigation_home)
